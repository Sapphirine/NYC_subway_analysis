...
if __name__ == "__main__":	
	fileHandle1 = "data_1.csv"
	fileHandle2 = "data_2.csv"
	fileHandle3 = "data_3.csv"
	main(fileHandle1)
	main(fileHandle2)
	main(fileHandle3)
	merge("data_1_final.csv","data_2_final.csv","data_3_final.csv","data_1_batch.csv","data_2_batch.csv","data_3_batch.csv")
